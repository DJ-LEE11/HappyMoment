package com.example.circle_base_ui.widget.imageview;
...
public class PreviewImageView<T> extends FlowLayout implements ViewGroup.OnHierarchyChangeListener {
    ...
    private LayoutParams generateDefaultImageSizeLayoutParams() {
        LayoutParams params = new LayoutParams(mImageSize, mImageSize);
