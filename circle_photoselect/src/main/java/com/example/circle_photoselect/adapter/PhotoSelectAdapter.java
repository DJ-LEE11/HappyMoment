...
import com.example.circle_base_ui.widget.imageview.CheckImageView;
...
import static com.example.circle_photoselect.photoselect.fragment.PhotoGridFragement.MAX_COUNT;
...
public class PhotoSelectAdapter extends BaseRecyclerViewAdapter<ImageInfo> {
     ...
     * <p>
     * {@link com.example.circle_photoselect.photoselect.fragment.PhotoGridFragement#updateSelectList(List)}以及{@link com.example.circle_photoselect.photoselect.PhotoMultiBrowserActivity#finish()}
     */
