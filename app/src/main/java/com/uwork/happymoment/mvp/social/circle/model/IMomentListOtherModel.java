...
public class IMomentListOtherModel extends IBaseListPageModel<HomeCircleBean> implements IMomentListOtherContract.Model <HomeCircleBean>{
    ...
    public IMomentListOtherModel(Context context) {
        super(context);
    }
    ...
    public ResourceSubscriber loadNext(OnModelCallBack<PageResponseBean<HomeCircleBean>> callBack) {
        return startObservable(ApiServiceFactory.INSTANCE
                        ...
                        .getMomentsListOther(mUserId,mPager == null ? ConstantManager.DEFAULT_THE_FIRST_PAGE_INDEX : (mPager.getPageNum() + 1)
