...
import com.example.circle_base_ui.widget.commentwidget.OnCommentUserClickListener;
...
import static com.uwork.happymoment.mvp.social.circle.ui.comment.MomentCommentLayout.ExpandState.COLLAPSED;
import static com.uwork.happymoment.mvp.social.circle.ui.comment.MomentCommentLayout.ExpandState.COLLAPSING;
import static com.uwork.happymoment.mvp.social.circle.ui.comment.MomentCommentLayout.ExpandState.EXPANDED;
import static com.uwork.happymoment.mvp.social.circle.ui.comment.MomentCommentLayout.ExpandState.EXPANDING;
...
public class MomentCommentLayout extends LinearLayout implements ViewGroup.OnHierarchyChangeListener {
    ...
    public MomentCommentLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public MomentCommentLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
