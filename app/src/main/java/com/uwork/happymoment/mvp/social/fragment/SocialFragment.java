...
public class SocialFragment extends BaseFragment {
    ...
    private void sendCircleText() {
        ActivityLauncher.startToPublishActivityWithResult(getActivity(), RouterList.PublishMomentActivity.MODE_TEXT, null, RouterList.PublishMomentActivity.requestCode);
    }
