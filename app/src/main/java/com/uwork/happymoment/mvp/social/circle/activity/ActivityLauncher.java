...
public class ActivityLauncher {
     ...
     * @param requestCode
     */
    public static void startToPublishActivityWithResult(Activity act, @RouterList.PublishMomentActivity int mode, @Nullable List<ImageInfo> selectedPhotos, int requestCode) {
        Intent intent = new Intent(act, PublishMomentActivity.class);
        intent.putExtra(RouterList.PublishMomentActivity.key_mode, mode);
        if (selectedPhotos != null) {
            intent.putParcelableArrayListExtra(RouterList.PublishMomentActivity.key_photoList, (ArrayList<? extends Parcelable>) selectedPhotos);
        }
