...
public class StickyLayout extends LinearLayout {
    ...
    public StickyLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.StickLayout);
        isStickNav = a.getBoolean(R.styleable.StickLayout_isStickNav, false);
        stickOffset = a.getDimensionPixelSize(R.styleable.StickLayout_stickOffset, 0);
        a.recycle();
    ...
    protected void onFinishInflate() {
        ...
        mTop = findViewById(R.id.id_sticky_header);
        mNav = findViewById(R.id.id_sticky_indicator);
        View view = findViewById(R.id.id_sticky_view_pager);
        ...
        if (a instanceof FragmentPagerAdapter) {
            ...
            if (v != null) {
                mInnerScrollView = (ViewGroup) (v
                        .findViewById(R.id.id_sticky_scrollview));
            }
