package com.uwork.happymoment.util.createCode;
...
public class CreateCodeUtil {
     ...
     *
     * @param text 样式字符串文本
     * @return {@link CreateCodeUtil.Builder}
     */
    public static CreateCodeUtil.Builder builder(@NonNull CharSequence text) {
        return new CreateCodeUtil.Builder(text);
    }
    ...
    public static class Builder {
        ...
        public Bitmap into(ImageView imageView) {
            Bitmap bitmap = CreateCodeUtil.creatQRCode(content, codeSide, codeSide, backgroundColor, codeColor);
            if (imageView != null) {
