...
import static com.uwork.happymoment.util.FileUtil.getDataColumn;
import static com.uwork.happymoment.util.FileUtil.isDownloadsDocument;
import static com.uwork.happymoment.util.FileUtil.isExternalStorageDocument;
import static com.uwork.happymoment.util.FileUtil.isGooglePhotosUri;
import static com.uwork.happymoment.util.FileUtil.isMediaDocument;


/**
 * @author 李栋杰
 * @time 2017/12/21  上午10:04
 * @desc 拍照、相册、裁剪
 */
public class PhotoUtil {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastUtils.show(context,"请先获取写入SDCard权限");
        } else {
