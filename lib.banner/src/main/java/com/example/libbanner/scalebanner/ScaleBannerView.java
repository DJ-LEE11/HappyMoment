package com.example.libbanner.scalebanner;
...
import com.example.libbanner.scalebanner.holder.ScaleHolderCreator;
import com.example.libbanner.scalebanner.holder.ScaleViewHolder;
import com.example.libbanner.scalebanner.transformer.CustomTransformer;
...
public class ScaleBannerView<T> extends RelativeLayout {
    ...
    private boolean mIsHomeAd;// 是否是首页广告
    ...
    private void readAttrs(Context context, AttributeSet attrs){
        ...
        mIsHomeAd = typedArray.getBoolean(R.styleable.ScaleBannerView_isHomeAd,false);
    ...
    private void init(){
      View view = null;
        if(mIsOpenThreeEffect){//首页广告
            if (mIsHomeAd){
                view = LayoutInflater.from(getContext()).inflate(R.layout.banner_home_ad_layout,this,true);
            }else {
                view = LayoutInflater.from(getContext()).inflate(R.layout.banner_scale_layout,this,true);
            }
        }else{
